...
const BLUE_FRAME = preload("res://assets/frames/blue_frame.png")
const GREEN_FRAME = preload("res://assets/frames/green_frame.png")
const RED_FRAME = preload("res://assets/frames/red_frame.png")
const YELLOW_FRAME = preload("res://assets/frames/yellow_frame.png")
const FRAME_IMAGES: Array[Texture2D] = [
	GREEN_FRAME, RED_FRAME, YELLOW_FRAME, BLUE_FRAME
]
...
func _ready() -> void:
	...
	for file_path in ir.get_file_paths():
